...
partial class NeoBinarySerializer
{
	...
	/// </summary>
	private object DeserializeAssembly(Type expectedType, BinaryReader reader,
	...
	/// </summary>
	private void SerializeMemberInfo(object memberInfoObj, BinaryWriter writer, HashSet<object> serializedObjects,
	...
	/// </summary>
	private object DeserializeMemberInfo(Type expectedType, BinaryReader reader,
		Dictionary<int, object> deserializedObjects, int objectId)
	{
		var nullMarker = reader.ReadByte();
		if (nullMarker == 0) return null;
	...
	/// </summary>
	private void SerializeParameterInfo(object parameterInfoObj, BinaryWriter writer, HashSet<object> serializedObjects,
		Dictionary<object, int> objectMap)
	{
		...
		if (parameterInfo.IsOptional) SerializeObject(parameterInfo.DefaultValue, writer, serializedObjects, objectMap);
	}

	/// <summary>
	/// Deserializes ParameterInfo objects.
	/// </summary>
	private object DeserializeParameterInfo(Type expectedType, BinaryReader reader,
		Dictionary<int, object> deserializedObjects, int objectId)
	{
		var nullMarker = reader.ReadByte();
		if (nullMarker == 0) return null;
	...
	/// </summary>
	private void SerializeModule(object moduleObj, BinaryWriter writer, HashSet<object> serializedObjects,
		Dictionary<object, int> objectMap)
	{
		if (moduleObj == null)
		{
	...
	/// </summary>
	private object DeserializeModule(Type expectedType, BinaryReader reader,
		Dictionary<int, object> deserializedObjects, int objectId)
	{
		var nullMarker = reader.ReadByte();
		if (nullMarker == 0) return null;
	...
	/// </summary>
	private void SerializeAssembly(object assemblyObj, BinaryWriter writer, HashSet<object> serializedObjects,
		Dictionary<object, int> objectMap)
	{
		if (assemblyObj == null)
		{
