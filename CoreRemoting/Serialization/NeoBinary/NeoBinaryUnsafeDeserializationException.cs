...
namespace CoreRemoting.Serialization.NeoBinary
{
    ...
    public class NeoBinaryUnsafeDeserializationException : Exception
    {
        ...
        /// <param name="assemblyName">The assembly name</param>
        /// <returns>A new NeoBinaryUnsafeDeserializationException instance</returns>
        public static NeoBinaryUnsafeDeserializationException ForDangerousTypeCombination(string typeName, string assemblyName)
        {
        ...
        /// <returns>A new NeoBinaryUnsafeDeserializationException instance</returns>
        public static NeoBinaryUnsafeDeserializationException ForDangerousInterface(string typeName, string assemblyName, string interfaceName)
        {
