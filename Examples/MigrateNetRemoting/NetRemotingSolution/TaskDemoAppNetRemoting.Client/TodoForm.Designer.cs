...
namespace TaskDemoAppNetRemoting.Client
{
    partial class TodoForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            var stream = executingAssembly.GetManifestResourceStream("TaskDemoAppNetRemoting.Client.Resources.add.ico");
            var iconAdd = new System.Drawing.Bitmap(stream); 
            stream.Dispose();

            stream = executingAssembly.GetManifestResourceStream("TaskDemoAppNetRemoting.Client.Resources.delete.ico");
